...
/*
 * Generate plate with a lotus hole
 */
/*
module lotus_plate(n) {
    translate([0, 0, n])
    difference() {
        translate([0, 0, .5])
...
if (0) {
    color("lightblue")      lotus_plate(1);
    color("blue")           lotus_plate(2);
    color("darkblue")       lotus_plate(3);
    color("LightSkyBlue")   lotus_plate(4);
}
*/
