...
module support1(support_extra, h, recess, is_bottom) {
    ...
    for (y=[-SUPPORT_WIDTH:step:SUPPORT_WIDTH-step]) {
        ...
        hull() {
            ...
            translate([SUPPORT_SIZE + support_extra, step/2, -SUPPORT_SIZE - support_extra - 1]) cubelet();
        }
    }
...
module support_2_one() {
    difference() {
        color("grey") union() {
            ...
            hull() {
                translate([7, -48, 45.1 +1])
                cubelet3();
                translate([15.2, -48, 45.1 +1])
                cubelet3();

                translate([7, -48, 45.1 -9+2.7])
                cubelet3();
        ...
        translate([0, -LAYER_H0/2, -LAYER_V0])
        plateau_2r();        
    }
}
