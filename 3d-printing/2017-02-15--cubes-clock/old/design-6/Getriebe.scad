...
spiel = 0.10;	// Spiel zwischen Zähnen
...
// planetengetriebe(modul=1, zahnzahl_sonne=24, zahnzahl_planet=9, hoehe=5, randbreite=3, bohrung=1.95*2*0 + 3, eingriffswinkel=20, schraegungswinkel=30);

 planetengetriebe(modul=1, zahnzahl_sonne=36, zahnzahl_planet=9, hoehe=4, randbreite=2, bohrung=3, eingriffswinkel=20, schraegungswinkel=30*0);
