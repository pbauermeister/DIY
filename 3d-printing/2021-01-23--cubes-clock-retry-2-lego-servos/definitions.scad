...
GRIPPER_THICKNESS = 5;
GRIPPER_MARGIN = 3;
GRIPPER_BALL_DIAMETER = 1.5;

GRIPPER_ADJUST = 1;  // increase to loosen plate and gripper
GRIPPER_CROWN_RADIUS0 = CUBE_WIDTH/2-GRIPPER_MARGIN;
GRIPPER_CROWN_CIRC = PI*GRIPPER_CROWN_RADIUS0*2;
GRIPPER_STEPS = 360;
GRIPPER_TOOTH = GRIPPER_CROWN_CIRC / GRIPPER_STEPS / sqrt(2);
GRIPPER_CROWN_RADIUS = GRIPPER_CROWN_RADIUS0 - GRIPPER_TOOTH*sqrt(2)/2 -PLAY/2*GRIPPER_ADJUST;

GRIPPER_AXIS_EXTRA_HEIGHT = 17;  // could be computed, should be verified

// GROOVE

GROOVE_DEPTH = 1.5;
GROOVE_MARGIN = 1.5  -.5;
GROOVE_THICKNESS = 0.66;
