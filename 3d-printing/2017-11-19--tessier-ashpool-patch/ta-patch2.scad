...
BACK_THICKNESS = 0.4; // adjust to obtain the thinnest possible layer for your printer in fine quality
// The total thickness will be LOGO_THICKNESS+BACK_THICKNESS+BACK_BORDER_THICKNESS

// Desired length:
LENGTH = 60; // set to 0 to keep length defined in vector graphics
// Note: aspect ratio is preserved

// BACK BORDER
// -----------
BACK_BORDER_THICKNESS = 0.2*0; // the back layer will have a border this deep
...
BACK_DXF = "design2b-base.dxf"; // "design-back.dxf"; // - non-empty -> use it as back
