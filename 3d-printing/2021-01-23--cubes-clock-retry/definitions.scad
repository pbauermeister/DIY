...
// Cavity
SERVO_CABLE_CAVITY_THICKNESS = 7;
SERVO_CABLE_CAVITY_THICKNESS_OFFSET_X = 3;
...
SCREW2_HEIGHT = 12*2; // overall

//
// SUPPORT - BOTTOM
//

SUPPORT_DIAMETER = CUBE_WIDTH - (CUBE_WALL_THICKNESS + TOLERANCE)*2;
